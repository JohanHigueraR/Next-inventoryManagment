      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="overflow-auto h-full">
            {Array.isArray(dashboardMetrics?.popularProducts) && dashboardMetrics.popularProducts.length > 0 ? (
              ...
              <div className="px-7 py-7 text-[var(--color-gray-500)]">No popular products found.</div>
            )}
          </div>
        </>
      )}
